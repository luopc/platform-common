...
import com.luopc.platform.web.common.core.util.SimpleCollection;
...
class SimpleCollectionTest {
    ...
    public void testBuildTree() {
        ...
        //获取树结构
        List<DeptTreeVO> tree = SimpleCollection.buildTree(dtos, DeptTreeVO::getId, DeptTreeVO::getParentId, DeptTreeVO::getCreateTime, DeptTreeVO::setChild);
