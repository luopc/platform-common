...
public class SimpleNumIDUtil {
    ...
    public static long nextPkId() {
        ...
        try {
            ...
            String randomNum = String.format("%04d", SimpleNumberUtil.randomLong(1, 9999));
    ...
    public static long shortId() {
        ...
        //当前：（年、月、日、时、分、秒、毫秒）
        String result = year + dayHours + minutes +
                String.valueOf(nextPkId()).substring(10);
