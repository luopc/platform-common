package com.luopc.platform.web.common.core.resilience.checkers;

import com.luopc.platform.web.common.core.resilience.HealthCheckResult;
import com.luopc.platform.web.common.core.resilience.HealthChecker;
...
public class HotWarmHealthChecker implements HealthChecker {
    ...
    private boolean checkResilience() {
        ...
        return true; //SmartNumberUtil.nextInt(100) % 2 == 0;
    }
