...
import com.luopc.platform.web.common.core.util.os.DisksInfo;
import com.luopc.platform.web.common.core.util.os.NetworkInfo;
 ...
 */
@Slf4j
public class SimpleSystemInfoUtil {
    ...
    static {
        try {
            ...
            log.error("Unable to get system information", e);
        }
    }
    ...
    public static OSRuntimeInfo getOSRuntimeInfo() throws InterruptedException {
        ...
        osRuntimeInfo.setAvailableMemory(globalMemory.getAvailable());
        //系统使用量
    ...
    public static OSInfo getSystemInfo() {
        ...
        osInfo.setFamily(operatingSystem.getFamily());
        //系统架构
        osInfo.setOsArch(props.getProperty("os.arch"));
        //java版本
        osInfo.setJavaRuntimeName(props.getProperty("java.runtime.name"));
        osInfo.setJavaVersion(props.getProperty("java.version"));
        osInfo.setJavaVmVendor(props.getProperty("java.vm.vendor"));
        //工作目录
        osInfo.setUserDir(props.getProperty("user.dir"));
        //CPU核数
        osInfo.setCpuCount(centralProcessor.getLogicalProcessorCount());
        osInfo.setPhysicalCoresCount(centralProcessor.getPhysicalProcessorCount());
        //主机信息
        try {
