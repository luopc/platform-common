package com.luopc.platform.web.handler;

import com.luopc.platform.web.exception.BaseException;
import com.luopc.platform.web.exception.ExceptionCatch;
import com.luopc.platform.web.exception.log.AppErrorCodeLogger;
import com.luopc.platform.web.exception.log.AppErrorCodeLoggerFactory;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> jsonFormatExceptionHandler(Exception e) {
        return ResponseEntity.badRequest().body(new BusinessException(PlatformErrorCode.NOT_READABLE));
    }
    ...
    public ResponseEntity<?> paramExceptionHandler(Exception e) {
        ...
        return ResponseEntity.badRequest().body(PlatformErrorCode.PARAM_ERROR);
    }
    ...
    public ResponseEntity<?> errorHandler(Throwable e) {
        return ResponseEntity.internalServerError().body(new BusinessException(PlatformErrorCode.SYSTEM_ERROR));
    }
